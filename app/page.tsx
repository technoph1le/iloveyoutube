...
export default function Home() {
  return (
    <>
      <section>
        <div className="wrapper py-8 text-center space-y-4">
          <h1 className="text-4xl font-bold">
            Every tool you need to work with{" "}
            <span className="text-accent-foreground">YouTube</span> in one place
          </h1>
          <p className="max-w-[90ch] mx-auto text-lg text-secondary-foreground">
            All your favorite YouTube tools in one place — 100% FREE and easy to
